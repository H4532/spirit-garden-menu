(()=>{
  ...
  const photos={
    ...
    "turkish-coffee":p(11311471),"v60-colombian":p(29261561),"v60-ethiopian":p(29619139),"v60-indonesian":p(29619140),"luxury-crop":p(32391648),"coffee-day":p(1445116572660),"red-tea":p(1417945),"green-tea":p(230477),"saudi-coffee":p(3026809),"saudi-dallah":p(723198),"ginger-herbal":p(1638280),"sahab":p(1509042239860),
    "ice-americano":p(2615323),"ice-latte":p(1461023058943),"ice-spanish":p(312418),"ice-white-mocha":p(1193335),"ice-dark-mocha":p(1233319),"ice-caramel":p(1036444),"ice-shikin":p(2615323),"ice-signature-latte":p(6207297),
    "ice-chocolate":p(867935),"ice-matcha":p(5946973),"karkadeh":p(616836),"orange-juice":p(96974),"lemon-juice":p(96974),"berry-mojito":p(544961),"passion-fruit":p(338713),"cored":p(544961),"nova-water":p(327090),
  ...
  const fallback={
    signature:p(893509),"hot-coffee":p(28762018),drip:p(29261561),traditional:p(11311471),iced:p(2615323),refreshing:p(544961),sandwiches:p(20219988),bakery:p(3892469),desserts:p(1126359)
  };
